...
# Load silkscreen font. Make sure the path is correct, or comment this out and uncomment the previous line above to use the default font. 
font = ImageFont.truetype('/home/USER/Adafruit_CircuitPython_seesaw/font/slkscr.ttf', 8) 
...
def iothub_client_telemetry_sample_run():
    try:
        ...
        while True:
            ...
            msg_txt_formatted = '{{"Temperature": {:.2f}, "Moisture": {:.2f}, "Hostname": "{}"}}'.format(temp, touch, hostname)
            message = Message(msg_txt_formatted)
            print("Sending message: {}".format(message))
            client.send_message(message)
            print("Message successfully sent")
            time.sleep(600)  #<-- runs every 10 minutes. You can change this value for testing.
