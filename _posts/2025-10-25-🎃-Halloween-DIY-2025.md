...
<!-- Eyeball-in-a-Jar Slideshow (Beautiful-Jekyll/GitHub Pages compatible) -->
<div class="eye-slideshow" data-delay="2500">
  <figure class="eye-slides">
    <img loading="lazy" src="{{ '/assets/img/Halloween25/jar/Reptile.jpg' | relative_url }}"     alt="Green reptile iris in a jar">
    <img loading="lazy" src="{{ '/assets/img/Halloween25/jar/Sauron.jpg' | relative_url }}"      alt="Fiery Eye of Sauron in a jar">
    <img loading="lazy" src="{{ '/assets/img/Halloween25/jar/whitewalker.jpg' | relative_url }}" alt="Blue white-walker iris in a jar">
    <img loading="lazy" src="{{ '/assets/img/Halloween25/jar/eye.jpg' | relative_url }}"         alt="Classic eyeball in a jar">
    <img loading="lazy" src="{{ '/assets/img/Halloween25/jar/fire.jpg' | relative_url }}"        alt="Orange flaming iris in a jar">
    <img loading="lazy" src="{{ '/assets/img/Halloween25/jar/goat.jpg' | relative_url }}"        alt="Yellow goat/slit pupil iris in a jar">
  </figure>
  <div class="eye-dots" aria-hidden="true"></div>
  <noscript>
    <div class="eye-grid">
      <img src="{{ '/assets/img/Halloween25/jar/Reptile.jpg' | relative_url }}" alt="">
      <img src="{{ '/assets/img/Halloween25/jar/Sauron.jpg' | relative_url }}" alt="">
      <img src="{{ '/assets/img/Halloween25/jar/whitewalker.jpg' | relative_url }}" alt="">
      <img src="{{ '/assets/img/Halloween25/jar/eye.jpg' | relative_url }}" alt="">
      <img src="{{ '/assets/img/Halloween25/jar/fire.jpg' | relative_url }}" alt="">
      <img src="{{ '/assets/img/Halloween25/jar/goat.jpg' | relative_url }}" alt="">
    </div>
  </noscript>
</div>
...
.eye-slides { position: relative; width:100%; padding-top:100%; overflow:hidden; }
.eye-slides img { position:absolute; inset:0; width:100%; height:100%; object-fit:contain; opacity:0; transition:opacity .6s ease-in-out; }
...
document.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('.eye-slideshow').forEach(function (root) {
    const slides = root.querySelectorAll('.eye-slides img');
    const dotsCt = root.querySelector('.eye-dots');
    slides.forEach(() => dotsCt.insertAdjacentHTML('beforeend','<span class="dot"></span>'));
    const dots = dotsCt.querySelectorAll('.dot');

    let i = 0;
    const delay = parseInt(root.getAttribute('data-delay') || '2500', 10);
